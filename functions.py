...
def sign_and_parity(integer):
    integer_dets = []
    if integer > 0:
        integer_dets.append("Positive")
    else:
        integer_dets.append("Negative")
    if integer % 2 == 0:
        integer_dets.append("Even")
    else:
        integer_dets.append("Odd")
...
def write_letter(recipient, job_title, sender):
    print(f"Dear {job_title} {recipient}, I think you are amazing! Sincerely, {sender}")
